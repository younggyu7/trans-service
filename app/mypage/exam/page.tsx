...
export default function ExamListPage() {
  const getTypeBadgeColor = (type: ExamType) => {
    if (type === '번역') {
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex flex-col items-end gap-3 flex-shrink-0">
                <Link href={getExamLink(exam)}>
                  <span className="inline-block px-4 py-1.5 rounded-md text-sm font-semibold bg-blue-600 text-white hover:bg-blue-700">시험보기</span>
                </Link>
